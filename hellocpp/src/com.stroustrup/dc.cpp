...
static int no_of_errors;	// note: default initialized to 0

static double error(const char* s)
{
    no_of_errors++;
    cerr << "error: " << s << '\n';
    return 1;
...
static Token_value curr_tok = PRINT;
...
static double expr(bool);	// cannot do without
...
static double expr(bool get)		// add and subtract
{
